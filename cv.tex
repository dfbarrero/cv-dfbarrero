...
\addbibresource{cvstays.bib} % Include your bibtex projects file here. Format: fileName.bib
...
\input{biblatex_modifications/stay_modification.tex}        % Modifying the default standard.tex style of Biblatex. This modification is performed to include the moderntimeline package.
...
\printbibliography[type=stay, keyword=research, heading=none]

\subsection{Educational and cooperation stays}

\printbibliography[type=stay, keyword=education, heading=none]
