...
\cvitem{Calification}{Outstanding \textit{cum laudem} (10). European mention.}
...
\cvdoubleitem{\textbf{Robotics}}{ROS}{\textbf{Tools}}{ECJ, Weka, Inspyred, PyBrain, NumPy, Pandas, Matplotlib, Seaborn, Jupyter, Anaconda, Knime}
